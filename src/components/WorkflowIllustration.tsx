...
const CODE_LINES = [
  [
    { t: "import ", c: "kw" }, { t: "{ Pipeline }", c: "var" },
    { t: " from ", c: "kw" }, { t: "\"@sourcecode/workflow\"", c: "str" },
  ],
  [],
  [
    { t: "const ", c: "kw" }, { t: "flows", c: "var" },
    { t: " = new ", c: "txt" }, { t: "Pipeline", c: "cls" },
    { t: "({", c: "txt" },
  ],
  [
    { t: "  trigger", c: "prop" }, { t: ": ", c: "txt" },
    { t: "\"form_submit\"", c: "str" }, { t: ",", c: "txt" },
  ],
  [
    { t: "  steps", c: "prop" }, { t: ": [", c: "txt" },
    { t: "\"qualify\"", c: "str" }, { t: ", ", c: "txt" },
    { t: "\"drip\"", c: "str" }, { t: ", ", c: "txt" },
    { t: "\"invoice\"", c: "str" }, { t: "],", c: "txt" },
  ],
  [
    { t: "  notify", c: "prop" }, { t: ": [", c: "txt" },
    { t: "\"slack\"", c: "str" }, { t: ", ", c: "txt" },
  ...
  [
    { t: "await ", c: "kw" },
    { t: "flows", c: "var" }, { t: ".", c: "txt" },
    { t: "start", c: "fn" }, { t: "()", c: "txt" },
  ],
];

const OUTPUT = [
  { text: "$ sourcecode workflow start", delay: 0 },
  { text: "  ▸ initialising pipelines...", delay: 0.3 },
  { text: "  ✓ lead-qualifier    active", delay: 0.65 },
  { text: "  ✓ email-drip        active", delay: 1.0 },
  { text: "  ✓ client-onboarding active", delay: 1.35 },
  { text: "  ✓ invoice-automation active", delay: 1.7 },
  { text: "  → 4 flows running   ✦", delay: 2.1, accent: true },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ color: "rgba(255,255,255,0.3)" }}>workflows.ts</span>
        <motion.button
      ...
      <div className="px-3 py-3 space-y-[2px]">
        {CODE_LINES.map((tokens, i) => (
          <motion.div
            key={i}
            className="flex items-center gap-3 px-2 py-[3px] rounded cursor-default select-none"
            animate={{
              backgroundColor:
                hoveredLine === i && tokens.length > 0
                  ? "rgba(255,255,255,0.04)"
                  : "rgba(0,0,0,0)",
            }}
            transition={{ duration: 0.12 }}
            onHoverStart={() => tokens.length > 0 && setHoveredLine(i)}
      ...
      <AnimatePresence>
        {!showOut && (
          ...
          >
            <Play size={10} />
            <span>press run to start flows</span>
          </motion.div>
        )}
      </AnimatePresence>
              ...
              <div className="space-y-1">
                ...
                {running && outCount < OUTPUT.length && (
                  <motion.span
                    ...
                    className="inline-block w-2.5 h-[11px] rounded-sm"
                    style={{ background: "var(--og-accent)" }}
                  />
                )}
              </div>
