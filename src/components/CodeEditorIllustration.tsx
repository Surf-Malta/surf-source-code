...
const CODE_LINES = [
  [
    { t: "import ", c: "kw" }, { t: "{ deploy }", c: "var" },
    { t: " from ", c: "kw" }, { t: "\"@sourcecode/core\"", c: "str" },
  ],
  [],
  [
    { t: "const ", c: "kw" }, { t: "project", c: "var" },
    { t: " = {", c: "txt" },
  ],
  [
    { t: "  stack", c: "prop" }, { t: ": [", c: "txt" },
    { t: "\"React\"", c: "str" }, { t: ", ", c: "txt" },
    { t: "\"AI\"", c: "str" }, { t: ", ", c: "txt" },
    { t: "\"Node\"", c: "str" }, { t: "],", c: "txt" },
  ],
  [
    { t: "  timeline", c: "prop" }, { t: ": ", c: "txt" },
    { t: "\"6 weeks\"", c: "str" }, { t: ",", c: "txt" },
  ],
  [
    { t: "  ai", c: "prop" }, { t: ": ", c: "txt" },
    { t: "true", c: "kw" }, { t: ",", c: "txt" },
  ...
  [
    { t: "await ", c: "kw" },
    { t: "deploy", c: "fn" }, { t: "(", c: "txt" },
    { t: "project", c: "var" }, { t: ")", c: "txt" },
  ],
];

const OUTPUT = [
  { text: "$ sourcecode deploy", delay: 0 },
  { text: "  ▸ resolving dependencies...", delay: 0.35 },
  { text: "  ✓ TypeScript compiled (0.8s)", delay: 0.75 },
  { text: "  ✓ assets optimised (12 files)", delay: 1.15 },
  { text: "  ✓ AI pipeline connected", delay: 1.55 },
  { text: "  ✓ deployed to edge network", delay: 1.95 },
  { text: "  → https://app.client.mt  ✦ live", delay: 2.4, accent: true },
];
  ...
  return (
    <div className="rounded-2xl overflow-hidden font-mono text-[11px]"
      ...
      <div className="flex items-center justify-between px-4 py-2.5"
        ...
        <span style={{ color: "rgba(255,255,255,0.3)" }}>deploy.ts</span>
        <motion.button
      ...
      <div className="px-3 py-3 space-y-[2px]">
        {CODE_LINES.map((tokens, i) => (
          ...
          >
            <span className="w-4 text-right shrink-0" style={{ color: "rgba(255,255,255,0.18)" }}>{i + 1}</span>
              ...
              <div className="space-y-1">
                {OUTPUT.slice(0, outCount).map((line, i) => (
                  <motion.div
                    ...
                    style={{ color: line.accent ? "var(--og-accent)" : "rgba(255,255,255,0.45)", fontWeight: line.accent ? 600 : 400 }}
                  >
                    {line.text}
                  </motion.div>
                ))}
